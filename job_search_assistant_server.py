...
class JobSearchAssistant:
    def __init__(self, url, embedding_model_name, chat_model_name):
        ...
        self.question_classify_dict = {
            ...
            "薪资&薪资范围&期望薪资": {
                "response": "上一家单位薪资为20K*15，当前我期望薪资为20K～40K。",
            ...
            "空闲时间": {
                "response": "请您稍等，我看一下我的时间。",
                "examples": [{"text": "明天你看看什么时间方便。", "label": "空闲时间"}]
            },
            "会议邀请": {
                "response": "请您稍等，我看一下我的时间。",
        ...
        以下是应聘者信息，以下这些信息只有被问到时才输出。
        ```
        姓名：于先生。
        工作经历：
        - 准创业项目 2024年5月至今 担任自然语言处理工程师 工作内容：基于LangChain的求职助手，基于llama3-70B模型，实现HR问题分类、简历检索、职位匹配度计算。
