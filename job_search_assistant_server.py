...
class JobSearchAssistant:
    def __init__(self, url, embedding_model_name, chat_model_name):
        ...
        ```
        工作经历：
        - 中国科学院信息工程研究所 2018年8月至2024年5月 自然语言处理工程师 负责短文本分类 离职。
        - 苏宁易购 2017年8月至2018年7月 自然语言处理工程师 负责商品标题分类和属性词抽取 离职。
        - 同方知网 2015年3月至2017年7月 计算语言学工程师 负责论文抄袭检测算法设计实现 离职。
        现居住地：北京。
        期望工作地：北京广渠门附近或地铁方便，通勤时间1小时以内。
        教育背景：北京信息科技大学 硕士/本科。
        联系方式：请问我的主人。
        期望职位：自然语言处理(NLP)、大模型。
